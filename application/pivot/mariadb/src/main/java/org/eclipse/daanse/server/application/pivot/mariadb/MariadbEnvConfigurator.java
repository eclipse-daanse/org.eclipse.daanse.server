...
/**
 * Registers the MariaDB DataSource from the {@code DAANSE_JDBC_*} environment
...
public class MariadbEnvConfigurator {

    private static final Logger logger = LoggerFactory.getLogger(MariadbEnvConfigurator.class);

    private static final String DIALECT_NAME = "MARIADB";
    ...
    public void activate() throws IOException {
        ...
        if (!missing.isEmpty()) {
            logger.error("Not configuring the MariaDB DataSource, required environment variables are not set: {}",
                    missing);
            return;
        }
        ...
        logger.info("MariaDB DataSource, connection pool and context configured from environment");
    }
